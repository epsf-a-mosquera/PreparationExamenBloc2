#PreparationExamenBloc2/src/extract_transform.py
'''
...
from src.eco_impact import track_phase  # NEW : mesure carbone ETL
...
def upsert_clean_dataset(
    ...
    """
    # NEW: créer les dossiers de sortie si besoin
    for p in (csv_path, parquet_path, jsonl_path):
...
def extract_transform():
    # NEW : mesure la phase ETL (lecture JSON -> nettoyage -> sauvegardes)
    with track_phase("etl_extract_transform"):
