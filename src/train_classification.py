# PreparationExamenBloc2/src/train_classification.py
"""
...
from src.eco_impact import track_phase  # NEW : mesure training classification
...
def main():
    # NEW : mesure préparation features + entraînement + sauvegardes
    with track_phase("ml_train_classification"):
